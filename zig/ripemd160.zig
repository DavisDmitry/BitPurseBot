/// translated from https://github.com/DaveCTurner/tiny-ripemd160
...
pub export fn ripemd160(arg_data: [*c]const u8, arg_data_len: u32, arg_digest_bytes: [*c]u8) void {
    var data = arg_data;
    var data_len = arg_data_len;
    var digest_bytes = arg_digest_bytes;
    var digest: [*c]u32 = @as([*c]u32, @ptrCast(@alignCast(digest_bytes)));
    {
        var i: u8 = 0;
        while (@as(c_int, @bitCast(@as(c_uint, i))) < @as(c_int, 5)) : (i +%= 1) {
            digest[i] = ripemd160_initial_digest[i];
        }
    }
    var last_chunk_start: [*c]const u8 = data + (data_len & @as(u32, @bitCast(~@as(c_int, 63))));
    while (data < last_chunk_start) {
        ripemd160_update_digest(digest, @as([*c]u32, @ptrCast(@alignCast(@volatileCast(@constCast(data))))));
        data += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 64)))));
    }
    var last_chunk: [64]u8 = undefined;
    var leftover_size: u8 = @as(u8, @bitCast(@as(u8, @truncate(data_len & @as(u32, @bitCast(@as(c_int, 63)))))));
    {
        var i: u8 = 0;
        while (@as(c_int, @bitCast(@as(c_uint, i))) < @as(c_int, @bitCast(@as(c_uint, leftover_size)))) : (i +%= 1) {
            last_chunk[i] = (blk: {
                const ref = &data;
                const tmp = ref.*;
                ref.* += 1;
    ...
    last_chunk[leftover_size] = 128;
    {
        var i: u8 = @as(u8, @bitCast(@as(i8, @truncate(@as(c_int, @bitCast(@as(c_uint, leftover_size))) + @as(c_int, 1)))));
        while (@as(c_int, @bitCast(@as(c_uint, i))) < @as(c_int, 64)) : (i +%= 1) {
            last_chunk[i] = 0;
        }
    }
    if (@as(c_int, @bitCast(@as(c_uint, leftover_size))) >= @as(c_int, 56)) {
        ripemd160_update_digest(digest, @as([*c]u32, @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(&last_chunk)))))));
        {
            var i: u8 = 0;
            while (@as(c_int, @bitCast(@as(c_uint, i))) < @as(c_int, 56)) : (i +%= 1) {
                last_chunk[i] = 0;
            }
        }
    }
    var length_lsw: [*c]u32 = @as([*c]u32, @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(&last_chunk))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 56))))))));
    length_lsw.* = data_len << @intCast(3);
    var length_msw: [*c]u32 = @as([*c]u32, @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(&last_chunk))) + @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 60))))))));
    length_msw.* = data_len >> @intCast(29);
    ripemd160_update_digest(digest, @as([*c]u32, @ptrCast(@alignCast(@as([*c]u8, @ptrCast(@alignCast(&last_chunk)))))));
}
pub export var ripemd160_initial_digest: [5]u32 = [5]u32{
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 1732584193))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 4023233417))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 2562383102))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 271733878))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 3285377520))))),
};
pub export var ripemd160_rho: [16]u8 = [16]u8{
    7,
    4,
    13,
    1,
...
pub export var ripemd160_shifts: [80]u8 = [80]u8{
    11,
    14,
    15,
    12,
...
pub export var ripemd160_constants_left: [5]u32 = [5]u32{
    0,
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 1518500249))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 1859775393))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 2400959708))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 2840853838))))),
};
pub export var ripemd160_constants_right: [5]u32 = [5]u32{
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 1352829926))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 1548603684))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 1836072691))))),
    @as(u32, @bitCast(@as(c_uint, @truncate(@as(c_ulong, 2053994217))))),
    0,
};
pub export var ripemd160_fns_left: [5]u8 = [5]u8{
    1,
    2,
    3,
    4,
...
pub export var ripemd160_fns_right: [5]u8 = [5]u8{
    5,
    4,
    3,
    2,
...
pub export fn ripemd160_compute_line(arg_digest: [*c]u32, arg_words: [*c]u32, arg_chunk: [*c]u32, arg_index: [*c]u8, arg_shifts: [*c]u8, arg_ks: [*c]u32, arg_fns: [*c]u8) void {
    var digest = arg_digest;
    var words = arg_words;
    var chunk = arg_chunk;
    var index = arg_index;
    var shifts = arg_shifts;
    var ks = arg_ks;
    var fns = arg_fns;
    {
        var i: u8 = 0;
    ...
    }
    {
        ...
        while (true) : (round +%= 1) {
            ...
            {
                var i: u8 = 0;
                while (@as(c_int, @bitCast(@as(c_uint, i))) < @as(c_int, 16)) : (i +%= 1) {
                    var tmp: u32 = undefined;
                    while (true) {
                        switch (@as(c_int, @bitCast(@as(c_uint, @"fn")))) {
                            @as(c_int, 1) => {
                                tmp = (words[@as(c_uint, @intCast(@as(c_int, 1)))] ^ words[@as(c_uint, @intCast(@as(c_int, 2)))]) ^ words[@as(c_uint, @intCast(@as(c_int, 3)))];
                                break;
                            },
                            @as(c_int, 2) => {
                                tmp = (words[@as(c_uint, @intCast(@as(c_int, 1)))] & words[@as(c_uint, @intCast(@as(c_int, 2)))]) | (~words[@as(c_uint, @intCast(@as(c_int, 1)))] & words[@as(c_uint, @intCast(@as(c_int, 3)))]);
                                break;
                            },
                            @as(c_int, 3) => {
                                tmp = (words[@as(c_uint, @intCast(@as(c_int, 1)))] | ~words[@as(c_uint, @intCast(@as(c_int, 2)))]) ^ words[@as(c_uint, @intCast(@as(c_int, 3)))];
                            ...
                            @as(c_int, 4) => {
                                tmp = (words[@as(c_uint, @intCast(@as(c_int, 1)))] & words[@as(c_uint, @intCast(@as(c_int, 3)))]) | (words[@as(c_uint, @intCast(@as(c_int, 2)))] & ~words[@as(c_uint, @intCast(@as(c_int, 3)))]);
                                break;
                            },
                            @as(c_int, 5) => {
                                tmp = words[@as(c_uint, @intCast(@as(c_int, 1)))] ^ (words[@as(c_uint, @intCast(@as(c_int, 2)))] | ~words[@as(c_uint, @intCast(@as(c_int, 3)))]);
                    ...
                    tmp +%= (words[@as(c_uint, @intCast(@as(c_int, 0)))] +% chunk[index[i]]) +% k;
                    tmp = ((tmp << @intCast(@as(c_int, @bitCast(@as(c_uint, shifts[index[i]]))))) | (tmp >> @intCast(@as(c_int, 32) - @as(c_int, @bitCast(@as(c_uint, shifts[index[i]])))))) +% words[@as(c_uint, @intCast(@as(c_int, 4)))];
                    words[@as(c_uint, @intCast(@as(c_int, 0)))] = words[@as(c_uint, @intCast(@as(c_int, 4)))];
                    words[@as(c_uint, @intCast(@as(c_int, 4)))] = words[@as(c_uint, @intCast(@as(c_int, 3)))];
                    words[@as(c_uint, @intCast(@as(c_int, 3)))] = (words[@as(c_uint, @intCast(@as(c_int, 2)))] << @intCast(@as(c_int, 10))) | (words[@as(c_uint, @intCast(@as(c_int, 2)))] >> @intCast(@as(c_int, 32) - @as(c_int, 10)));
                    words[@as(c_uint, @intCast(@as(c_int, 2)))] = words[@as(c_uint, @intCast(@as(c_int, 1)))];
                    words[@as(c_uint, @intCast(@as(c_int, 1)))] = tmp;
                }
            }
            if (@as(c_int, @bitCast(@as(c_uint, round))) == @as(c_int, 4)) {
                break;
            }
            shifts += @as(usize, @bitCast(@as(isize, @intCast(@as(c_int, 16)))));
            var index_tmp: [16]u8 = undefined;
            {
                var i: u8 = 0;
                while (@as(c_int, @bitCast(@as(c_uint, i))) < @as(c_int, 16)) : (i +%= 1) {
...
pub export fn ripemd160_update_digest(arg_digest: [*c]u32, arg_chunk: [*c]u32) void {
    var digest = arg_digest;
    var chunk = arg_chunk;
    ...
    var words_left: [5]u32 = undefined;
    ripemd160_compute_line(digest, @as([*c]u32, @ptrCast(@alignCast(&words_left))), chunk, @as([*c]u8, @ptrCast(@alignCast(&index))), @as([*c]u8, @ptrCast(@alignCast(&ripemd160_shifts))), @as([*c]u32, @ptrCast(@alignCast(&ripemd160_constants_left))), @as([*c]u8, @ptrCast(@alignCast(&ripemd160_fns_left))));
    index[@as(c_uint, @intCast(@as(c_int, 0)))] = 5;
    {
        var i: u8 = 1;
        while (@as(c_int, @bitCast(@as(c_uint, i))) < @as(c_int, 16)) : (i +%= 1) {
            index[i] = @as(u8, @bitCast(@as(i8, @truncate((@as(c_int, @bitCast(@as(c_uint, index[@as(c_uint, @intCast(@as(c_int, @bitCast(@as(c_uint, i))) - @as(c_int, 1)))]))) + @as(c_int, 9)) & @as(c_int, 15)))));
        }
    }
    var words_right: [5]u32 = undefined;
    ripemd160_compute_line(digest, @as([*c]u32, @ptrCast(@alignCast(&words_right))), chunk, @as([*c]u8, @ptrCast(@alignCast(&index))), @as([*c]u8, @ptrCast(@alignCast(&ripemd160_shifts))), @as([*c]u32, @ptrCast(@alignCast(&ripemd160_constants_right))), @as([*c]u8, @ptrCast(@alignCast(&ripemd160_fns_right))));
    digest[@as(c_uint, @intCast(@as(c_int, 0)))] +%= words_left[@as(c_uint, @intCast(@as(c_int, 1)))] +% words_right[@as(c_uint, @intCast(@as(c_int, 2)))];
    digest[@as(c_uint, @intCast(@as(c_int, 1)))] +%= words_left[@as(c_uint, @intCast(@as(c_int, 2)))] +% words_right[@as(c_uint, @intCast(@as(c_int, 3)))];
    digest[@as(c_uint, @intCast(@as(c_int, 2)))] +%= words_left[@as(c_uint, @intCast(@as(c_int, 3)))] +% words_right[@as(c_uint, @intCast(@as(c_int, 4)))];
    digest[@as(c_uint, @intCast(@as(c_int, 3)))] +%= words_left[@as(c_uint, @intCast(@as(c_int, 4)))] +% words_right[@as(c_uint, @intCast(@as(c_int, 0)))];
    digest[@as(c_uint, @intCast(@as(c_int, 4)))] +%= words_left[@as(c_uint, @intCast(@as(c_int, 0)))] +% words_right[@as(c_uint, @intCast(@as(c_int, 1)))];
    words_left[@as(c_uint, @intCast(@as(c_int, 0)))] = digest[@as(c_uint, @intCast(@as(c_int, 0)))];
    digest[@as(c_uint, @intCast(@as(c_int, 0)))] = digest[@as(c_uint, @intCast(@as(c_int, 1)))];
    digest[@as(c_uint, @intCast(@as(c_int, 1)))] = digest[@as(c_uint, @intCast(@as(c_int, 2)))];
    digest[@as(c_uint, @intCast(@as(c_int, 2)))] = digest[@as(c_uint, @intCast(@as(c_int, 3)))];
    digest[@as(c_uint, @intCast(@as(c_int, 3)))] = digest[@as(c_uint, @intCast(@as(c_int, 4)))];
    digest[@as(c_uint, @intCast(@as(c_int, 4)))] = words_left[@as(c_uint, @intCast(@as(c_int, 0)))];
}
...
pub const __DARWIN_ALIAS_STARTING_MAC___MAC_14_0 = @compileError("unable to translate C expr: unexpected token 'Eof'"); // /Library/Developer/CommandLineTools/SDKs/MacOSX.sdk/usr/include/sys/_symbol_aliasing.h:773:9
...
pub inline fn ROL(x: anytype, n: anytype) @TypeOf((x << n) | (x >> (@as(c_int, 32) - n))) {
    return (x << n) | (x >> (@as(c_int, 32) - n));
}
